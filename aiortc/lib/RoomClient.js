...
class RoomClient {
 constructor({
  ...
  this._protooUrl = urlFactory_1.getProtooUrl({
   roomId,
   peerId,
   forceH264,
   forceVP8,
 ...
 join() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   const protooTransport = new protoo_client_1.default.WebSocketTransport(
    this._protooUrl
   );
   this._protoo = new protoo_client_1.default.Peer(protooTransport);
   store.dispatch(stateActions.setRoomState('connexion'));
     ...
     case 'newPeer': {
      ...
      store.dispatch(
       stateActions.addPeer(
        Object.assign(Object.assign({}, peer), {
         consumers: [],
         dataConsumers: [],
        })
       )
 ...
 disableMic() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   try {
    yield this._protoo.request('closeProducer', {
 ...
 muteMic() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   try {
    yield this._protoo.request('pauseProducer', {
     producerId: this._micProducer.id,
    });
 ...
 unmuteMic() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   try {
    yield this._protoo.request('resumeProducer', {
     producerId: this._micProducer.id,
    });
 ...
 changeWebcam() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   if (!this._webcamProducer) throw new Error('webcam not enabled');
   store.dispatch(stateActions.setWebcamInProgress(true));
   let stream;
   let track;
   try {
 ...
 restartIce() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   try {
    if (this._sendTransport) {
     const iceParameters = yield this._protoo.request('restartIce', {
 ...
 getSendTransportLocalStats() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   if (!this._sendTransport) return undefined;
 ...
 getRecvTransportLocalStats() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   if (!this._recvTransport) return undefined;
  ...
  return __awaiter(this, void 0, void 0, function* () {
   ...
   const stats = {
    ...
    recvTransport: recvTransportStats
     ...
     : undefined,
    audio: audioStats ? Array.from(audioStats.values()) : undefined,
    video: videoStats ? Array.from(videoStats.values()) : undefined,
   };
   clearInterval(this._localStatsPeriodicTimer);
 ...
 _joinRoom() {
  return __awaiter(this, void 0, void 0, function* () {
   ...
   try {
    ...
    const routerRtpCapabilities = yield this._protoo.request(
