      ...
      dataConsumer.on('message', (message) => {
       ...
       switch (dataConsumer.label) {
        case 'chat': {
         ...
         store.dispatch(
          requestActions.notify({
           title: `${sendingPeer.displayName} dit:`,
           text: message,
           timeout: 5000,
          })
         );
 ...
 async changeWebcam() {
  ...
  try {
   ...
   store.dispatch(
    requestActions.notify({
     type: 'error',
     text: `Impossible de modifier la webcam: ${error}`,
    })
   );
  }
 ...
 async changeWebcamResolution() {
  ...
  try {
   ...
   store.dispatch(
    requestActions.notify({
     type: 'error',
     text: `Impossible de changer la résolution de la webcam: ${error}`,
    })
   );
  }
 ...
 async changeDisplayName(displayName) {
  ...
  try {
   ...
   store.dispatch(
    requestActions.notify({
     type: 'error',
     text: `Impossible de modifier votre pseudo: ${error}`,
    })
   );
 ...
 async _joinRoom() {
  ...
  try {
   ...
   store.dispatch(
    requestActions.notify({
     type: 'error',
     text: `Impossible de rejoindre la visioconférence: ${error}`,
    })
   );
